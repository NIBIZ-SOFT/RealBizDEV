...
if ( isset($_REQUEST["VoucherNo"])){
    ...
    $journalvouchers=SQL_Select("advancedpaymentvendor where VoucherNo='{$_REQUEST["VoucherNo"]}'");


//    echo "<pre>";
//    print_r($journalvouchers);
//    die();
    ...
    foreach ($journalvouchers as $journalvoucher){
        ...
        if ($journalvoucher["dr"] > 0 ){
            $fromProjectName=$journalvoucher["CategoryName"];

            $form=$journalvoucher["dr"];


        }else{
            $toProjectName=$journalvoucher["CategoryName"];
