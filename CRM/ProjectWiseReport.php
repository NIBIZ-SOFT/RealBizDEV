...
//    all Project
        $sl=1;
        $CRMJunk = SQL_Select("CRM","ProjectID ={$_REQUEST["CategoryID"]} and LeadsStatus='Fake' ");
        $CRMBooked = SQL_Select("CRM","ProjectID ={$_REQUEST["CategoryID"]} and LeadsStatus='Booked' ");
        $CRMFollowUp = SQL_Select("CRM","ProjectID ={$_REQUEST["CategoryID"]} and LeadsStatus='Follow Up' ");

        $CRMList = SQL_Select("CRM","ProjectID ={$_REQUEST["CategoryID"]} and Date BETWEEN '{$_REQUEST["FromDate"]}' and '{$_REQUEST["ToDate"]}'");
...
//    all Project
        $sl=1;
        $CRMJunk = SQL_Select("CRM"," LeadsStatus='Fake' ");
        $CRMBooked = SQL_Select("CRM"," LeadsStatus='Booked' ");
        $CRMFollowUp = SQL_Select("CRM"," LeadsStatus='Follow Up' ");

        $CRMList = SQL_Select("CRM"," Date BETWEEN '{$_REQUEST["FromDate"]}' and '{$_REQUEST["ToDate"]}'");
...
<div style="width: 95%; margin: auto">
    ...
    <div class="projectName text-center m-b-30 m-t-30">
        <h4 style="font-weight: bold">Project Wise Report</h4>
        <p class="text-right">From: '.$FromDate.' To:  '.$ToDate.'</p>
        
        Total Client : '.($sl-1).' &nbsp;&nbsp;|&nbsp;&nbsp; Follow Up : '.count($CRMFollowUp).' &nbsp;&nbsp;|&nbsp;&nbsp; Junk : '.count($CRMJunk).'
        <br>
        Total Call : '.$TotalCall.' &nbsp;&nbsp;|&nbsp;&nbsp; Total Meeting : '.$TotalMeeting.' &nbsp;&nbsp;|&nbsp;&nbsp; Booked : '.count($CRMBooked).'
    </div>
