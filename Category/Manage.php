<?
	...
	$MainContent.= CTL_Datagrid(
		$Entity,
		$ColumnName=array("CategoryID","Name", "ProjectLoactionName" , "Address" , "Facing" , "BuildingHeight" ,"LandArea"  ,"ProjectLaunchingDate" ,  "HandOver"   ,"{$Entity}IsActive" ),
		$ColumnTitle=array( "Project ID" ,"Project Name" , "Project Location", "Address", "Facing" ,"Building Height","Land Area", "Project Launching Date", "Hand Over Date"  ,"IsActive" ),
		$ColumnAlign=array( "left"  ,"left"  ,"left" ," left" , "left" ,"left"  , "left","left", "left", "left" ),
		$ColumnType=array( "text"  ,"text"  ,"text" ,"text" , "text", "text" , "text" ,"date", "date", "yes/no"),
