<?
    ...
    GetPermission("OptionCheckManager");
	...
	$MainContent.= CTL_Datagrid(
		$Entity,
		$ColumnName=array( "CustomerName" , "BankName" , "ChequeNumber" , "ChequeAmount" ,"ChequeDate" , "SubmittedDate", "{$Entity}IsActive" ),
		$ColumnTitle=array( "Customer Name", "Bank Name" , "Cheque Number" ,"Cheque Amount" , "Cheque Date", "Submitted Date"   ,"Submitted?" ),
		$ColumnAlign=array( "left", "left" , "left" , "left" ,"left" , "left", "left"   ),
		$ColumnType=array( "text", "text" , "text" ,"text" , "date" , "date"  ,"yes/no"),
