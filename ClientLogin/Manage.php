<?
    ...
    $Where="UserCategory='Client'";
	if($_POST["FreeText"]!="")
		$Where.=" and UserCategory='Client' and {$_REQUEST["SearchCombo"]} LIKE '%{$_POST["FreeText"]}%'";

	// DataGrid
	$MainContent.= CTL_Datagrid(
		$Entity,
		$ColumnName=array("UserID", "UserName" , "NameFirst" , "UserEmail" , "PhoneHome"   ,"{$Entity}IsActive" ),
		$ColumnTitle=array( "User ID","User Name", "Name First" , "User Email" , "Phone"   ,"IsActive" ),
