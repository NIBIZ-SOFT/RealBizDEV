...
if ( isset($_REQUEST["VoucherNo"])){
    ...
    $contravouchers=SQL_Select("contravoucher where VoucherNo={$_REQUEST["VoucherNo"]}");
//
//    echo "<pre>";
//    print_r($contravouchers);
//    die();
    ...
    foreach ($contravouchers as $contravoucher){
        ...
        $description= $contravoucher["Description"];
        ...
        $tr .='   
            <tr>
                ...
                <td>'.$contravoucher["BankCashName"].'</td>
                <td>'.$contravoucher["ChequeNumber"].'</td>
                <td>'.BangladeshiCurencyFormat($contravoucher["dr"]).'</td>
                <td>'.BangladeshiCurencyFormat($contravoucher["cr"]).'</td>
...
<div class="print-area">
            ...
            <div style="padding: 10px 0px;" class="company-name row">
                ...
                <div class="col-md-3"> 
                    <div class="requisitionNo"> 
                        <p>Voucher No.</p>
                        <p>'. str_pad($_GET["VoucherNo"],"4","0",STR_PAD_LEFT) .'</p>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row" style="margin-bottom: 20px"> 
            <div class="col-md-5 col-sm-5 col-xs-3 col-lg-5"> 
                <div class="description"> 
                    <p>Project Name: '.$contravouchers[0]["ProjectName"].'</p>
            ...
            <div class="col-md-5 col-sm-5 col-xs-3 col-lg-5"> 
                <div class="description">  
                    <p>Location: '.GetProjectAddress($contravouchers[0]["ProjectID"]).'</p>
            ...
            <div class="col-md-2 col-sm-2 col-xs-2 col-lg-2"> 
                <div class="description">  
                    <p>Date: '.HumanReadAbleDateFormat($contravouchers[0]["Date"]).'</p>
        ...
        <div class="print-rule-area">
            ...
            <p>Particulars: '.$contravouchers[0]["Description"].'</p>
