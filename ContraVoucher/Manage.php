<?
	...
	$MainContent.= CTL_Datagrid(
		$Entity,
		$ColumnName=array( "ProjectName" , "BankCashName" , "ChequeNumber" , "VoucherNo" , "dr" , "cr"  ),
		$ColumnTitle=array( "Project Name", "Head Of Account Name"  , "Cheque Number" , "Voucher No" , "dr" , "cr" ),
		...
		$AdditionalLink=array(ApplicationURL("ContraVoucher","ContraVoucher&NoHeader&NoFooter&VoucherNo="))
