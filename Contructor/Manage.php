<?
	GetPermission("OptionContructor");
	...
	$MainContents.="
		<img style=\"vertical-align: middle;width:35px;height:30px;\" src=\"./theme/default/images/vendor.png\">&nbsp;&nbsp;&nbsp;<b style=\"font-size:16px;\">Vendor</b>
	";	
	...
	$MainContent.= CTL_Datagrid(
		$Entity,
		$ColumnName=array( "VendorName" , "Date" , "Address" , "VendorPhone" , "VendorEmail" ),
		$ColumnTitle=array( "Contructor Name", "Date" , "Mailing Address"  , "Contructor Phone" , "Contructor Email" ),
...
//		$AdditionalLinkField=array("ContructorID"),
//		$AdditionalLink=array(ApplicationURL("AdvancedPaymentContructor","Manage&ContructorID="))
