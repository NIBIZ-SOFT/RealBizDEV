<?
	...
	$MainContent.= CTL_Datagrid(
		$Entity,
		$ColumnName=array( "Department", "Name" , "Phone" , "Email" , "Position" , "Address"   ,"Salary" ),
		$ColumnTitle=array( "Enroll","Name", "Phone" , "Email" , "Position" ,  "Address"   ,"Salary" ),
