<?
	...
	$MainContent.= CTL_Datagrid(
		$Entity,
		$ColumnName=array( "Name" , "Category" , "SubmitterBy" , "DateAndTime"   ,"IsActive" ),
		$ColumnTitle=array( "Name", "Category" , "Submitter By" , "Date And Time"   ,"IsActive" ),
		$ColumnAlign=array( "left", "left" , "left" , "left"   , "left" ),
		$ColumnType=array( "text", "text" , "text" , "date"   ,"yes/no"),
