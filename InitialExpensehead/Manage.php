<?
  ...
  GetPermission("OptionIncomeExpenseHeadBalance");
   ...
   include "./script/{$_REQUEST["Base"]}/Scriptvariables.php";
	...
	$MainContent.= CTL_Datagrid(
		...
		$ColumnName=array( "ProjectName" ,"ExpenseHeadName" ,  "Balance" ,"Date" ),

		$ColumnTitle=array("ProjectName" , "ExpenseHeadName",  "Balance" ,"Date" ),

		$ColumnAlign=array( "left", "left" , "left", "left"  ),

		$ColumnType=array( "text", "text" , "text" ,"Date" ),
