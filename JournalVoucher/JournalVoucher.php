...
if ( isset($_REQUEST["VoucherNo"])){
    ...
    $GetVoucherNO = SQL_Select("journalvoucher","JournalVoucherID={$_REQUEST["VoucherNo"]}","",true);
    $_REQUEST["VoucherNo"]=$GetVoucherNO["VoucherNo"];
    $journalvouchers=SQL_Select("journalvoucher where VoucherNo={$_REQUEST["VoucherNo"]}");
    //$journalvouchers=SQL_Select("journalvoucher where JournalVoucherID={$_REQUEST["JournalVoucherID"]}");
    ...
    foreach ($journalvouchers as $journalvoucher){
        ...
        $dr +=$journalvoucher["dr"];
        $cr +=$journalvoucher["cr"];
        $description=$journalvoucher["Description"];

        $form=0;
        $to=0;

        if ($journalvoucher["dr"] > 0 ){
            $fromProjectName=$journalvoucher["ProjectName"];

            $form=$journalvoucher["dr"];


        }else{
            $journalvouchers_CR=SQL_Select("journalvoucher","VoucherNo={$_REQUEST["VoucherNo"]} and dr='0'","",true);

            $toProjectName=$journalvouchers_CR["ProjectName"];
            $to=$journalvoucher["cr"];
        ...
        if ($sl == 1){
            ...
            //$toProjectName=$journalvoucher["ProjectName"];
        }
        ...
        $tr .='
            <tr>
                ...
                <td>'.$journalvoucher["HeadOfAccountName"].'</td>
            ...
            <div style="padding: 10px 0px;" class="company-name row">
                ...
                <div class="col-md-3"> 
                    <div class="requisitionNo"> 
                        <p>Voucher No.</p>
                        <p>'. str_pad($_REQUEST["VoucherNo"],"4","0",STR_PAD_LEFT) .'</p>
                    </div>
                </div>
            </div>
        ...
        <div class="row" style="margin-bottom: 20px"> 
            <div class="col-md-5 col-sm-5 col-xs-3 col-lg-5"> 
                <div class="description"> 
                    <p>Project Name(Dr): '.$fromProjectName.'</p>
            ...
            <div class="col-md-5 col-sm-5 col-xs-3 col-lg-5"> 
                <div class="description">  
                    <p> Project Name(Cr): '.$toProjectName.'</p>
