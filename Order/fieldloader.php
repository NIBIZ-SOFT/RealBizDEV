      ...
      <tr>            
	        ...
	        <td>
                   ...
                   <td>			 
                    ...
                    <td>
					  <input type="text" value="" id="Price<?php echo $k;?>" name="Price<?php echo $k;?>" size="10" onkeyup="viewTotalPrice()">
                        /= Tk. 
                    </td>
					<td>
					<div style="width:17px;">
				   ...
				   <td>
				   <img onclick="fieldRemoveOne(<?php echo $k;?>)" style="border: #ff33cc; cursor: pointer; " alt="Delete" src="./theme/default/image/datagrid/Delete.gif">
