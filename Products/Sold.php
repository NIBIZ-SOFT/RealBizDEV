<?php
$sold_check=SQL_Select("products","ProductsIsActive='Sold'");
$n=1;
...
$MainContent.='
  <table style="width:100%;margin:0 auto" border="1">
     <tr>
	   <th colspan="11"><h3>Sold Report View</h3></th>
	 </tr>
     <tr>
	 ...
	 '.$soldhtml.'
	 <tr>
            <td colspan="8" style="text-align:right"> <b>Total Income From Sold Flat</b> </td>
