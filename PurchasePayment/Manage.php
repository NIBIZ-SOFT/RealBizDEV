...
$MainContent .= CTL_Datagrid(
    ...
    $AddButton = true,
    $AdditionalLinkCaption = array("PRINT<br>","Add Payment<br>"),
    $AdditionalLinkField = array("PurchaseID","PurchaseID"),
    $AdditionalLink = array(ApplicationURL("Purchase", "report&NoHeader&NoFooter&ID="),ApplicationURL("PurchasePayment", "AddPayment&ID="))
