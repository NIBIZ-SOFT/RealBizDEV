<?
	...
	$MainContent.= CTL_Datagrid(
		$Entity,
		$ColumnName=array( "CategoryName" , "ExpenseHeadName" , "BudgetQty", "BudgetDate"   ,"{$Entity}IsActive" ),
		$ColumnTitle=array( "Project Name", "Expense Head" , "BudgetQty", "BudgetDate"   ,"IsActive" ),
