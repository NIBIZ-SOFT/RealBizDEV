...
if (!empty($_REQUEST["Division"])) {
    ...
    foreach ($categories as $category) {
        $salesProjctDetails = SQL_Select("sales where Division='{$_REQUEST["Division"]}' and SalesDate BETWEEN '{$_REQUEST["FromDate"]}' and '{$_REQUEST["ToDate"]}' ORDER BY `SalesDate` Asc");

       // $salesProjctDetails = SQL_Select("sales where Division='{$_REQUEST["Division"]}' ORDER BY `SalesDate` Asc");
...
<div style="width: 95%; margin: auto">
    ...
    <div class="projectName text-center m-b-30 m-t-30">
        <h4 style="font-weight: bold">Division Wise Party Ledger Summary</h4>
