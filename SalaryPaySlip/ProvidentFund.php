...
<?php
    ...
    $UserData =  SQL_Select("user","pffundstatus='InActive' || pffundstatus=''");
  ...
  if(isset($_POST['username'])){
            ...
            $TheEntityNameData=array(                                                                                             
              "pffunddatesetup"=>$_POST["pfsetupdate"],
              "pffundstatus"=>$_POST["pffundstatus"],
            ),
            $Where
            );
    ...
    $Data = SQL_Select("user","pffundstatus='Active'");
    foreach($Data as $ThisData){
      $pfhtml.='
          ...
          <td> '.$ThisData['PFund'].' </td>
          <td> '.$ThisData['pffunddatesetup'].' </td>
          <td>
           <a style="color:blue">'.$ThisData['pffundstatus'].'</a> /
           <a  href="index.php?Theme=default&Base=SalaryPaySlip&Script=ProvidentFund&upid='.$ThisData['UserID'].'" style="cursor:pointer;color:green">View</a>
          </td>
          </tr>
      ';
  ...
  $SingleData=SQL_Select("user","UserID='$update'","",true,"","",false,"");
        ...
        /* update PF section */
   $actionhtnl.='
        <form action="index.php?Theme=default&Base=SalaryPaySlip&Script=ProvidentFund" method="post">
        <table style="text-align:center; width:70%;
         margin:0 auto;margin-top:20px; ">
          <tr>
             ...
             <td>
                Setup Date<br/>
                <input type="text" required value="'.$SingleData['pffunddatesetup'].'" name="pfsetupdate" id="pfsetupdate" class="pfsetupdate" />
             </td>
             <td>
                Setup Satus<br/>
                <select name="pffundstatus" required>
                   <option value="'.$SingleData['pffundstatus'].'">Setup '.$SingleData['pffundstatus'].'</option>
   ...
   ';
    ...
    $backhtml.='<span class="badge badge-info"><a style="color: white;font-size: 16px;" href="index.php?Theme=default&Base=SalaryPaySlip&Script=ProvidentFund">Back To Page</a></span>';
    $headhtml.='<span style="color:green"><b>'.$SingleData['FullName'].'</b> Provident Fund Update Section</span>';
        ...
        <table style="text-align:center; width:70%;
         margin:0 auto;margin-top:20px; ">
          <tr>
             ...
             <td>
                Setup Date<br/>
                <input type="text" required name="pfsetupdate" id="pfsetupdate" class="pfsetupdate"/>
             </td>
             <td>
                Setup Satus<br/>
                <select name="pffundstatus" required>
   ...
   ';
    ...
    $headhtml.='<span style="color:blue">Empolyee Provident Fund Set Section</span>';
   }
