     ...
     <div class="box_right">
	   ...
	   <table style="float: right;margin-top: 30px;">	   
	      <tr>
		     ...
		     <td><a target="_blank" href="index.php?Theme=default&Base=SalaryPaySlip&Script=PrintSlip&NoHeader&NoFooter&SalaryID='.$SalaryID.'" style="background-color: green;color: white;border-radius: 3px;padding: 2px 12px;font-size: 19px;margin-right: 17px;">Get Pay Slip</a></td>
