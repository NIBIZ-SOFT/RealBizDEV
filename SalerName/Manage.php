<?
	...
	$MainContent.= CTL_Datagrid(
		$Entity,
		$ColumnName=array( "Name" ,"Commission" ,"RestOfCommission" , "Description"   ,"{$Entity}IsActive" ),
		$ColumnTitle=array( "Name","Booking Commission","Rest Commission", "Description"   ,"IsActive" ),
