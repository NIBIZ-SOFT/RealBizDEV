...
$MainContent .= '<div class="mb-3"></div>';
...
$MainContent .= '
        ...
        action="index.php?Theme=default&Base=Sales&Script=import&NoHeader&NoFooter" method="post" 
	...
	$MainContent.= CTL_Datagrid(
		...
		$AddButton=true,
		$AdditionalLinkCaption=array("Set Schedule<br>"),
		$AdditionalLinkField=array("SalesID"),
		$AdditionalLink=array(ApplicationURL("SchedulePayment","Manage&SalesID="))
