...
if ( !empty($_POST["IncomeExpenseTypeID"])  and !empty($_POST["FromDate"]) and !empty($_POST["ToDate"]) and !empty($_POST["FromDate1"]) and !empty($_POST["ToDate1"]) ){
    ...
    foreach ($HeadOfItemDetails as $HeadOfItemDetail) {
        $headOfAccountAmount = GetBalanceHeadOfAccountIDWithDate($HeadOfItemDetail["ExpenseHeadID"], $FromDate, $ToDate);

        $headOfAccountAmount1 = GetBalanceHeadOfAccountIDWithDate($HeadOfItemDetail["ExpenseHeadID"], $FromDate1, $ToDate1);
