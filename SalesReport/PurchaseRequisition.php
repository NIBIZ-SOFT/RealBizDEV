...
foreach ($ProjectDetails as $ProjectDetail){
    ...
    if ( empty($_REQUEST["CategoryID"]) and empty($_REQUEST["FromDate"]) and empty($_REQUEST["ToDate"])  ){
        $purchaserequisitionDetails=SQL_Select("purchaserequisition where CategoryID={$ProjectDetail["CategoryID"]} and Confirm='Confirm' ");
        ...
        $purchaserequisitionDetails=SQL_Select("purchaserequisition where CategoryID={$ProjectDetail["CategoryID"]} and Confirm='Confirm' and RequiredDate BETWEEN '{$_REQUEST["FromDate"]}' AND  '{$_REQUEST["ToDate"]}' ");
