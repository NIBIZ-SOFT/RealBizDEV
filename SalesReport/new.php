...
<div style="margin-left: 20px;margin-right: 20px;" class=" mt-5">
    ...
    <h2 class="text-center">EMI Pending Payment's<br><hr></h2>
...
if ($tblsales[0]['SalesID']==$row['SalesID']){


                    echo "<tr>
                <td>{$sl}</td>
                <td>{$tblsales[0]['SalesID']}</td>
                <th>{$tblsales[0]['CustomerID']} - {$tblsales[0]['CustomerName']}</th>
                <th>{$tblsales[0]['SellerID']} - {$tblsales[0]['SellerName']}</th>
           ...
           <tr>
               ...
               <td style="font-weight: bold" colspan="2"><?=$cumulativeAllPendingAmount?></td>
