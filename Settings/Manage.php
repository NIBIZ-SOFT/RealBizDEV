<?
	...
	$MainContent.="
		<img style=\"vertical-align: middle;width:35px;height:30px;\" src=\"./theme/default/images/Settings.png\">&nbsp;&nbsp;&nbsp;<b style=\"font-size:16px;\">Settings</b>
	";	
	...
	$MainContent.= CTL_Datagrid(
		$Entity,
		$ColumnName=array( "CompanyName"  , "Address" , "City" , "Zip" , "Country" ),
		$ColumnTitle=array( "Company Name" , "Address" , "City" , "Zip" , "Country"    ),
