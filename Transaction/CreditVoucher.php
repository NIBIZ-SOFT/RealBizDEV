...
if (isset($_REQUEST["TransactionID"])) {
    ...
    $Transactions = SQL_Select("Transaction where TransactionID={$_REQUEST["TransactionID"]}");
            ...
            <div style="padding: 10px 0px;" class="company-name row">
                ...
                <div class="col-md-3"> 
                    <div class="requisitionNo"> 
                        <p>Voucher No.</p>
                        <p>' . str_pad($_GET["TransactionID"], "4", "0", STR_PAD_LEFT) . '</p>
                    </div>
                </div>
            </div>
        ...
        <div class="row" style="margin-bottom: 20px"> 
            <div class="col-md-5 col-sm-5 col-xs-3 col-lg-5"> 
                <div class="description"> 
                    <p>Project Name: ' . $Transactions[0]["ProjectName"] . '</p>
            ...
            <div class="col-md-5 col-sm-5 col-xs-3 col-lg-5"> 
                <div class="description">  
                    <p>Location: ' . GetProjectAddress($Transactions[0]["ProjectID"]) . '</p>
