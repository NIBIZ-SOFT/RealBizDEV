...
if (empty($_POST["CategoryID"]) and empty($_POST["FromDate"]) and empty($_POST["ToDate"])) {
...
//                Cr Formula
                ...
                $trHtml .= '
                    ...
                    <tr>
                        ...
                        <th class="text-center" scope="row">' . $UniqueTransactionHeadOfAccaunts[0]["GLCode"] . '</th>
            ...
            <tr>
                ...
                <th width="20px" class="text-center"  scope="col">GL Code</th>
            ...
            <tr>
                <th scope="col"></th>
                <th scope="col"></th>
                <th width="200px" class="text-right" scope="col">Payment</th>
                <th width="200px"  class="text-right"  scope="col">Receive</th>
            </tr>
            </thead>
...
//                Cr Formula
            ...
            $trHtml .= '
                    ...
                    <tr>
                        <th class="text-center" scope="row">' . $sl . '</th>
                        <th class="text-center" scope="row">' . $headOfAccauntsDetails[0]["GLCode"] . '</th>
        ...
        $projectHtml .= '
            ...
            <thead>
            <tr>
                <th class="text-center" scope="col" colspan="5">' . $ProjectName . '</th>
            </tr>
            </thead>
            ...
            <thead>
            <tr>
                <th class="text-right" scope="col" colspan="3">Sub Total =</th>
                <th scope="col" class="text-right">'.BangladeshiCurencyFormat($subDrTotal).'</th>
                <th scope="col" class="text-right">'.BangladeshiCurencyFormat($subCrTotal).'</th>
            </tr>
            </thead>
...
<div style="width: 95%; margin: auto">
    ...
    <div class="projectName text-center m-b-30 m-t-30">
        <h4 style="font-weight: bold">Receive & Payment</h4>
    </div>
   ...
   <!----  BankCash --->
    ...
    <table class="table table-bordered table-hover table-fixed table-sm">
            ...
            <tr>
                <th width="20px" class="text-center"  scope="col">Serial No.</th>
                <th  scope="col" class="text-center"> <h5>GL Code</h5></th> 
            ...
            <thead>
                <tr>
                    <th class="text-right" colspan="3" scope="col">Grand Total Amount=</th>
