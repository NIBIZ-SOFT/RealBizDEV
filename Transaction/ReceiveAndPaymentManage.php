    ...
    <div class="row row-cols-1 row-cols-md-2 row-cols-xl-3 g-4">
        <!-- Project Wise Ledger -->
            ...
            <div class="card shadow">
                <div class="card-header text-center bg-success text-white">All Receive & Payment</div>
                <div class="card-body">
        ...
        <div class="col">
            <div class="card shadow">
                <div class="card-header text-center bg-success text-white">Receive & Payment Project Wise With Opening Balance</div>
                <div class="card-body">
                    <form method="POST" action="' .ApplicationURL("Transaction","RPPRojectWise&NoHeader&NoFooter"). '">
                        <div class="mb-3">
